                  ...
                  layer.bindPopup(`
                    <div class="custom-popup">
                      ...
                      <div style="margin: 8px 0; padding: 8px; background: rgba(0,0,0,0.05); border-radius: 4px;">
                        <strong style="color: #1e293b;">Klasifikasi: ${riskClass.toUpperCase()}</strong><br>
                        <small>${riskDesc[riskClass] || 'Data risiko banjir'}</small>
                      </div>
                      <p style="margin: 4px 0; font-size: 0.85em;"><strong>Sumber:</strong> ${props.Catatan || 'BPBD Provinsi Jawa Barat'}</p>
                    </div>
                  `);
